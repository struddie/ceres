...
class PageBuilder {
	...
	function makeHomePage() {
		...
		$homePageContents .= file_get_contents("../fragments/".HOME_PAGE_NAME.".".MARKDOWN_FILE_EXTENSION).PHP_EOL.PHP_EOL;
		...
		$homePagePath = $_SERVER['DOCUMENT_ROOT']."/pages/".HOME_PAGE_NAME.".".MARKDOWN_FILE_EXTENSION;
	...
	function makeArchivePage() {
		...
		$archivePageContents .= file_get_contents("../fragments/".ARCHIVE_PAGE_NAME.".".MARKDOWN_FILE_EXTENSION).PHP_EOL.PHP_EOL;
		...
		$archivePagePath = $_SERVER['DOCUMENT_ROOT']."/pages/".ARCHIVE_PAGE_NAME.".".MARKDOWN_FILE_EXTENSION;
	...
	function makeSiteMap() {
		...
		$siteMapPageContents .= file_get_contents("../fragments/".SITEMAP_PAGE_NAME.".".MARKDOWN_FILE_EXTENSION).PHP_EOL.PHP_EOL;
		
		$pageExclusions = ['home', 'site_map']; // TODO: Change to @@ parameter in page
		$files = listdir_by_name('../pages/*.'.MARKDOWN_FILE_EXTENSION);
		...
		$sitemapPagePath = $_SERVER['DOCUMENT_ROOT'].'/pages/'.SITEMAP_PAGE_NAME.'.'.MARKDOWN_FILE_EXTENSION;
